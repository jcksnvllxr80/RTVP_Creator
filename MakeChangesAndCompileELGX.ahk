...
MsgBox Remove the changes stated in the difference report shown on the screen and PERFORM A CONSISTENCY CHECK TO ENSURE THERE ARE NO ERRORS. Next: If you are using manual compile, compile and close the compiler, then press ok. If the compiling is being done automatically, come back to the ELGX home screen (equations), then press OK to continue compiling.
IfWinExist, ACE
{
	WinActivate ACE
	Sleep 500
	...
	Sleep 200
	Send +c
	MsgBox Make sure there are no consistency errors or YOU WILL LOSE ALL OF YOUR WORK!
	Sleep 200
	WinActivate ACE
	Sleep 200
	Send ^s
